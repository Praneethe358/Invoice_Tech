  ...
  const faqs = [
    {
      ...
      a: 'Within 2 hours of payment confirmation. Usually it takes much less than that (within 10-15 minutes) during our business hours (9 AM - 9 PM).'
    },
    {
      ...
      <PageTransition className="w-full px-4 md:px-8 pt-6 md:pt-0 pb-24">
        ...
        <div className="mb-6 md:hidden">
          ...
          <p className="text-[10px] text-gray-500 font-semibold mt-1">
            Choose billing option and checkout using secure UPI transfer.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          {/* UPI Checkout Section */}
          <div className="md:col-span-6 bg-white border border-[#e5e7eb] rounded-none p-6 shadow-xs space-y-6">
            <div>
              <h2 className="text-base font-bold text-gray-900 uppercase tracking-tight font-heading">UPI Payments Checkout</h2>
              <p className="text-xs text-gray-400 mt-0.5">Scan QR or pay directly to the UPI ID below</p>
            </div>
            ...
            <div className="bg-[#fffbeb] border-l-4 border-amber-500 rounded-none p-4 space-y-3">
              ...
              <p className="text-xs text-amber-900 font-semibold leading-relaxed">
                After successful payment, send your transaction screenshot on WhatsApp for instant activation.
              </p>
