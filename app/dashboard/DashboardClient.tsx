        ...
        <div className="mb-6 space-y-3">
          <div className="relative">
            <input
              ...
              className="w-full bg-white rounded-2xl md:rounded-none border border-[#e5e7eb] py-3 pl-9 md:pl-10 pr-4 text-sm font-medium text-[#111827] focus:outline-none focus:border-[#0050e8] focus:ring-0 transition-all"
            />
