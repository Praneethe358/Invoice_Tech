...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f6fa]">
      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-[#e8eaed]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden p-2 text-[#4b5563] hover:text-[#1a1d26] transition-colors focus:outline-none"
      ...
      {/* ─── How It Works ─────────────────────────────────────── */}
      <section id="how-it-works" className="bg-[#fafbfc] border-y border-[#e8eaed]">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-[#e6f4ea] mb-8 max-w-md mx-auto">
              The easiest and fastest way to invoice customers on WhatsApp.
            </p>
            <Link
              href="/signup"
