...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex relative">
      ...
      {/* Right — Form */}
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 bg-[#f8fafc] bg-[radial-gradient(circle_at_top_right,rgba(0,80,232,0.06),transparent_45%),radial-gradient(circle_at_bottom_left,rgba(0,80,232,0.04),transparent_45%)] relative overflow-y-auto overflow-x-hidden">
