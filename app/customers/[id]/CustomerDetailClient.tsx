  ...
  return (
    <div className="min-h-screen bg-[#f5f6fa]">
      ...
      <PageTransition className="max-w-lg md:max-w-[1400px] mx-auto px-4 md:px-8 py-6 pb-24">
        ...
        <div className="bg-white border border-[#e5e7eb] -mx-4 md:-mx-8 px-6 md:px-10 py-5 -mt-6.5 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs mt-0.5 font-medium flex items-center gap-1.5">
                ...
                Customer Ledger & Transaction logs · {customer.name}
              </p>
            </div>
          </div>
          <button
            onClick={() => router.push('/customers')}
            className="flex items-center gap-2 text-xs font-bold text-slate-500 hover:text-slate-900 transition-colors self-start md:self-auto"
          >
