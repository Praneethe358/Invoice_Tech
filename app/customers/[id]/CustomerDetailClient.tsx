    ...
    <div className="min-h-screen bg-[#f5f6fa]">
      ...
      <PageTransition className="w-full px-4 md:px-8 pt-6 md:pt-0 pb-24">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[#6b7280] text-[10px] mt-0.5 font-medium">
                Customer Account Statement · {customer.name}
              </p>
            </div>
          </div>
          <button
        ...
        <button
          ...
          className="hidden md:flex mb-6 items-center gap-2 text-sm font-semibold text-[#6b7280] hover:text-[#111827] transition-colors cursor-pointer"
        >
