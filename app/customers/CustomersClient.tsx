    ...
    <div className="min-h-screen bg-[#f5f6fa]">
      ...
      <PageTransition className="w-full px-4 md:px-8 pt-6 md:pt-0 pb-24">
        ...
        <div className="mb-6 flex flex-col md:hidden justify-between gap-4">
          ...
          <button
            onClick={() => router.push('/customers/ledger')}
            className="flex items-center gap-1.5 bg-[#1a6b3c]/10 hover:bg-[#1a6b3c]/20 text-[#1a6b3c] font-bold py-2 px-3.5 rounded-xl text-xs transition-all cursor-pointer self-start"
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
              <polyline points="14 2 14 8 20 8" />
