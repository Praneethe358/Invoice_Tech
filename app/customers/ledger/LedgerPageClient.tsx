      ...
      <PageTransition className="w-full px-4 md:px-8 pt-6 md:pt-0 pb-24">
        ...
        <div className="bg-white border border-[#e5e7eb] -mx-4 md:-mx-8 px-6 md:px-10 py-5 shadow-xs flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4 md:sticky md:top-0 md:z-30">
          <div>
            ...
            <p className="text-[#6b7280] text-[10px] mt-0.5 font-medium hidden md:block">
          ...
          <div className="space-y-4 animate-fadeIn">
            <div className="relative">
              <input
                ...
                className="w-full bg-white rounded-xl border border-[#e5e7eb] py-3.5 pl-9 md:pl-11 pr-4 text-sm font-medium text-[#111827] focus:outline-none focus:border-[#0050e8]"
              />
              <svg className="absolute left-3 md:left-4 top-1/2 -translate-y-1/2 text-[#9ca3af] w-3.5 h-3.5 md:w-[18px] md:h-[18px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
