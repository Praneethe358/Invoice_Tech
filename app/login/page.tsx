              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-white pl-4 pr-10 py-3.5 text-xs sm:text-sm text-slate-800 placeholder-slate-400 outline-none transition-all focus:border-[#0050e8] focus:ring-2 focus:ring-[#0050e8]/15"
                  />
                  <button
                    type="button"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      autoComplete="current-password"
                      className="w-full rounded-xl border border-slate-200 bg-slate-50/60 pl-4 pr-10 py-3 text-sm text-slate-800 placeholder-slate-400 outline-none transition-all focus:border-[#0050e8] focus:bg-white focus:ring-4 focus:ring-[#0050e8]/5"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
