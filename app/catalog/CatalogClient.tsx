          ...
          {products.length === 0 ? (
            ...
            <div className="space-y-4">
              ...
              {filteredProducts.length === 0 ? (
                ...
                <div className="bg-white rounded-none border border-[#e5e7eb] overflow-hidden shadow-xs">
                        ...
                        >
                          <div className="flex items-start justify-between gap-2">
                            <div className="flex gap-2">
                              <button
                                onClick={() => handleToggleFavorite(product)}
                                className={`pt-0.5 transition-colors cursor-pointer ${
                          ...
                          <div className="flex items-center justify-between border-t border-[#f9fafb] pt-2">
                            <div className="flex gap-2">
                              {inventoryEnabledGlobal && product.track_inventory && (
                                <button
                                  onClick={() => {
                            ...
                            <div className="flex gap-3">
                              <button
                                onClick={() => startEdit(product)}
                                className="text-gray-400 hover:text-gray-600 text-xs font-bold flex items-center gap-1 cursor-pointer"
                              >
                                Edit
                              </button>
                              <button
