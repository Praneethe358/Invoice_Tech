            ...
            <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm space-y-6">
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 text-sm">Mobile / WhatsApp Support</h4>
                    <a href="tel:+916374197402" className="text-[#1E3A8A] hover:underline text-sm font-medium">
                      +91 63741 97402
                    </a>
                  </div>
                </div>
