-- Phase 20: Add Discount Support to Invoices and Invoice Items
-- Run this in your Supabase SQL Editor:
-- https://supabase.com/dashboard/project/_/sql

-- 1. Add discount column to invoices table if it doesn't exist
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS discount numeric(10,2) NOT NULL DEFAULT 0;

-- 2. Add discount column to invoice_items table if it doesn't exist
ALTER TABLE invoice_items ADD COLUMN IF NOT EXISTS discount numeric(10,2) NOT NULL DEFAULT 0;

-- 3. Recreate the atomic transaction function to support discounts
CREATE OR REPLACE FUNCTION create_invoice_sec(
  ...
  p_user_id uuid,
  p_discount numeric DEFAULT 0 -- 17th argument: overall discount
) RETURNS jsonb AS $$
DECLARE
  v_next_num int;
  v_prefix text;
